...
<body>
    ...
    <nav class="uk-navbar-container" uk-navbar>
        ...
        <div class="uk-navbar-right">
            ...
            <ul class="uk-navbar-nav">
                <li> <a class="uk-button uk-margin-small-right" type="button" uk-toggle="target: #modal-client">SignIN client</a></li>
                <li> <a class="uk-button uk-margin-small-right" type="button" uk-toggle="target: #modal-buisness">SignIN buisness</a></li>
            </ul>
            <?php else: ?>
            <ul class="uk-navbar-nav">
    ...
    <div id="modal-client" uk-modal>
        <div class="uk-flex uk-margin-auto">
            <div id="regClient" class="uk-card uk-card-default uk-card-hover uk-card-body uk-card-medium uk-width-large uk-margin-auto uk-margin-auto-vertical">
                ...
                <ul id="auth" class="uk-switcher uk-margin">
                    <li>
                        ...
                        <a href="#">
                            <div id="regEmail" class="uk-flex-middle uk-margin-small-top regHover" uk-grid>
                                <div class="uk-width-1-4">
            ...
            <div id="regMail" style="display:none" class="uk-flex uk-margin-auto">
        ...
        <div class="uk-flex uk-margin-auto">
            <div class="uk-card uk-card-default uk-card-hover uk-card-body uk-card-large uk-width-large uk-margin-auto uk-margin-auto-vertical">
                ...
                <form class="uk-form-stacked" action="/register/emailClient" method="post">
                    ...
                    <div class="uk-form-controls">
                        <div class="uk-inline uk-width-1-1">
                            <input class="uk-input" placeholder="Confirm password" id="password_confirm" name="password" type="password">
                        </div>
                    </div>
                    <div class="uk-text-center uk-margin-medium-bottom uk-margin-small-top"><a>forgot your password?</a></div>
                    <button class="uk-button uk-button-primary uk-width-1-1 uk-button-large uk-position-bottom" type="submit">Register</button>
                </form>
                <div class="">By signing up I agree to the Terms of Service and <a>Privacy Policy</a></div>
            </div>
        </div>
    </div>
</body>
